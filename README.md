...
**Latest Release:** v3.7.0 | [Release Notes](docs/releases/v3.7.0.md) | [Tutorial](docs/guides/tutorial.md) | [Examples](examples/) | [Breaking Changes](docs/v2.0.0-breaking-changes.md) | [Security Policy](SECURITY.md)
...
1.  **Download the tarball** (**141 MB** compressed; measured against the published v3.1.0 asset, not estimated):
    ...
    wget https://github.com/doublegate/CyberChef-MCP/releases/download/v3.7.0/cyberchef-mcp-v3.7.0-docker-image.tar.gz
    ```

2.  **Load the image into Docker:**

    ```bash
    docker load < cyberchef-mcp-v3.7.0-docker-image.tar.gz
    ```
