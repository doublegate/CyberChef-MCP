...
# Run MCP validation test suite (1,709 tests across 74 files, with Vitest)
npm run test:mcp
...
- **1,709 MCP tests** across 74 suites, plus 241 Node-API tests, 2,289 operation tests and 9 runnable examples executed by CI
