...
# Run MCP validation test suite (1,110 tests across 39 files, with Vitest)
npm run test:mcp
...
- **1,110 MCP tests** across 39 suites, plus 241 Node-API tests, 2,289 operation tests and 9 runnable examples executed by CI
...
- **Current coverage**: 96.62% lines, 95.77% statements, 96.42% functions, 89.30% branches
