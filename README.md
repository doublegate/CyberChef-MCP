...
# Run MCP validation test suite (1,108 tests across 39 files, with Vitest)
npm run test:mcp
...
- **1,108 MCP tests** across 39 suites, plus 241 Node-API tests, 2,289 operation tests and 9 runnable examples executed by CI
...
- **Current coverage**: 96.60% lines, 95.79% statements, 96.41% functions, 89.35% branches
