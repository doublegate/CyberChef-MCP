...
**CyberChef MCP Server** (v4.1.0) - Fork of GCHQ CyberChef wrapping the Node.js API into an MCP
server. Exposes 504 operations (encryption, encoding, compression, forensics) as AI assistant tools.

| Metric | Value |
|--------|-------|
| MCP Version | 4.1.0 (single source: `package.json` `version`, read by `src/node/lib/config.mjs`). `mcpVersion` was removed in v2.2.0 -- npm requires `version` to be the published version, so the upstream base moved to `cyberchefUpstreamVersion`. |
...
| Releases | `docs/releases/v4.1.0.md` (latest), then `v4.0.0.md`, `v3.11.0.md`, `v3.10.0.md`, `v3.9.0.md`, `v3.8.0.md`, `v3.7.0.md`, `v3.6.0.md`, `v3.5.0.md`, `v3.4.0.md`, `v3.3.0.md`, `v3.2.0.md`, `v3.1.0.md`, `v3.0.0.md`, `v2.10.0.md` ... `v2.0.0.md`, `v1.9.0.md` ... `v1.0.0.md` |
