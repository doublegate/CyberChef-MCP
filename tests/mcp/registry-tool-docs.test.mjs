...
/** Documents that must carry a written entry for every single tool. */
const INVENTORIES = ["docs/wiki/Analysis-Tools.md", "docs/guides/commands.md"];
    ...
    it("documents every registered tool by name", () => {
        ...
        for (const file of INVENTORIES) {
            ...
            for (const name of names) {
                if (!text.includes(`cyberchef_${name}`)) missing.push(`${file}: cyberchef_${name}`);
            }
        }
