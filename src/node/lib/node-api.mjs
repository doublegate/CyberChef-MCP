 ...
 *
 * That module imports **every one of the every operation implementation** eagerly, and importing it
 ...
 * on stdio, on every session -- paid 1.15 s to import every operation implementation it had not
 * been asked to run.
 *
