 ...
 *
 *     all       545 tools   424,897 bytes   415 KB
 *     curated   120 tools   107,739 bytes   105 KB
 *     index      42 tools    44,493 bytes    43 KB
 *
 ...
 * time. Measured, that trade is the index plus one operation schema -- 46,271 bytes against
 * 424,897, or **9.2x cheaper** than `all`. (This line read "42,415 bytes ... 9.5x" until v3.8.0,
