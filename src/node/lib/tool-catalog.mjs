 ...
 *
 *     all       546 tools   426,367 bytes   416 KB
 *     curated   121 tools   109,209 bytes   107 KB
 *     index      43 tools    45,963 bytes    45 KB
 *
 ...
 * time. Measured, that trade is the index plus one operation schema -- 47,741 bytes against
 * 426,367, or **8.9x cheaper** than `all`. (This line read "42,415 bytes ... 9.5x" until v3.8.0,
