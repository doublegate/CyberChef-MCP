...
class OutputWaiter {
    ...
    async setHTMLOutput(html) {
        ...
        // This code executes JavaScript from operation outputs (e.g., Entropy, ShowOnMap).
        // The scripts are generated by trusted CyberChef operations, not user input.
        // For additional security in untrusted contexts, implement CSP headers.
