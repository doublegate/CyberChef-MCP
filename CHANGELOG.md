...
- **`scripts/_agy_print.sh` prints a usage line instead of `$1: unbound variable`** (#49), and rejects an unreadable prompt file with a clear message. It is the script most likely to be run by hand while debugging a review.
