...
operations** for encryption, encoding, compression and forensics, plus **nineteen analysis tools**
...
| **[The Tool Surface](Tool-Surface)** | Why you see 23 tools and not 545 — the most common question |
