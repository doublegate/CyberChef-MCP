...
**Working as intended.** `tools/list` is an *index* by default: 23 tools and 15,291 bytes,
rather than 545 tools and 426,377 bytes. Nothing is unreachable — `cyberchef_bake` runs any of the 504
