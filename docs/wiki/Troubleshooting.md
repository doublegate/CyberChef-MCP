...
**Working as intended.** `tools/list` is an *index* by default: 42 tools and 44,493 bytes,
rather than 545 tools and 424,897 bytes. Nothing is unreachable — `cyberchef_bake` runs any of the 504
