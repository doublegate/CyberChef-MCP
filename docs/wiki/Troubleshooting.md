...
**Working as intended.** `tools/list` is an *index* by default: 43 tools and 45,647 bytes,
rather than 546 tools and 426,051 bytes. Nothing is unreachable — `cyberchef_bake` runs any of the 504
