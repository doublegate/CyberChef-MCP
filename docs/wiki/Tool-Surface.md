...
meta-tools costs roughly **426,367 bytes** before the user has typed anything — and model
...
|---|---|---|---|
| **`index`** *(default)* | 43 | 45 KB | **45,963** |
| `curated` | 121 | 107 KB | 109,209 |
| `all` | 546 | 416 KB | 426,367 |
...
make them unreachable rather than merely inconvenient. They form part of the 45,963-byte index
payload.
