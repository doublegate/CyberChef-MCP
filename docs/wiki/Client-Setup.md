...
**Set the tool surface deliberately for a local model.** The default (`index`, 42 tools,
44,406 bytes) is usually right; `all` is 545 tools and 424,810 bytes, which will swamp most
