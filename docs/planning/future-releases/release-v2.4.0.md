...
> **Superseded — this plan shipped as v2.5.0, not as the version in its title.**
>
> Releases from v2.1.0 onward ran one version ahead of this plan set, so "Enterprise Features"
> was delivered as **v2.5.0**. The authoritative record of what shipped is
> [`docs/releases/v2.5.0.md`](../../releases/v2.5.0.md); `ROADMAP.md` carries the
