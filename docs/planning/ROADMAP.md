...
**Current version:** **v4.0.0** (released 2026-09-11) · **Upstream base:** CyberChef v11.4.0
...
`v4.1.0` **shipped 2026-09-11**. `v4.2.0` (dispatch consolidation) is the next charter whose trigger
has fired; `v4.3.0`-`v4.5.0` were gated on v4.1.0 landing and are now unblocked.
