...
| | The byte win does not survive counting the dispatcher's own schema | Re-measured: the dispatcher costs **1,080 bytes** and the index landed at **15,291**, better than the `~15,905` projection |
