...
**272 open findings → 0.** Full disposition, with the reasoning for every suppression and
...
| `CYBERCHEF_ALLOWED_HOSTS` | *(unset)* | Host allowlist; enables DNS-rebinding protection. |
