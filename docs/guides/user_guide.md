...
|---|---|---|
| **`index`** *(default)* | 42 | **44,406 bytes** |
| `curated` | 120 | 107,652 bytes |
| `all` | 545 | 424,810 bytes |
...
tools account for roughly 20 KB of the 44,406-byte payload, and there is no honest way to avoid
paying it.
